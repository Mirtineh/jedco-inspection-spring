...
public class SalesAndLegalServiceImpl implements SalesAndLegalService {
    ...
    @Override
    public Page<Inspection> getAllInspectionsData(Long statusId, String startDateString, String endDateString, String customerName, String meterNumber, String legalCaseNo, List<Long> statuses, Pageable pageable) {
