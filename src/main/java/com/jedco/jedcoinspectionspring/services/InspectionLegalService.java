...
public interface InspectionLegalService {
    SalesInspectionResponse legalInspectionsListByDate(String startDate, String endDate, String customerName, String meterNumber, String legalCaseNo, List<Long> statuses, String problemType, int page, int limit, String sort);
